...
class InceptionV3Model(ProtoModel):
    """Classe che implementa le funzioni del modello InceptionV3
    """
    ...
    def predict(self, imgs: list, gscale=False) -> list:
        ...
        target_size = (299, 299)    # indica la dimenzione con cui deve essere ridimenzionata l'immagine
